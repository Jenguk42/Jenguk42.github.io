...
> ✒ Reference: [Node.js tutorial from W3 schools](https://www.w3schools.com/nodejs/nodejs_intro.asp)
...
This module should be downloaded and installed using NPM, by running `npm install formidable` on your console.